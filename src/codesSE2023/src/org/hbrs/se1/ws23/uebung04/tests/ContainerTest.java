package org.hbrs.se1.ws23.uebung04.tests;

import org.hbrs.se1.ws23.uebung04.model.persistence.PersistenceException;
import org.hbrs.se1.ws23.uebung04.model.persistence.PersistenceStrategyMongoDB;
...
class ContainerTest {
    ...
    void setUp() {
        ...
        persistenceStrategyStream.setLocation("./src/codesSE2023/src/org/hbrs/se1/ws23/uebung04/docs/tests.ser");
    }
